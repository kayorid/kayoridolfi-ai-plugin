# Comunidade Kayoridolfi AI Champions

> Charter formal da comunidade. Revisada semestralmente.

## 1. Propósito

Articular uma rede de praticantes avançados do Kayoridolfi AI Plugin que:
...
- Servem como ponte entre maintainers e squads
...
Qualquer pessoa de squad que tenha:

- (a) Completado pelo menos **3 ciclos SDD** completos no SDK (spec → impl → retro)
- (b) Contribuído com pelo menos **1 PR mergeado** ao kayoridolfi-ai-plugin OU **1 padrão promovido** via `/kai-retro-promote`
...
| Kayoridolfi AI Lab (workshop) | Quinzenal | 90min | Champion facilita, qualquer dev assiste |
| Newsletter trimestral | 1x/trimestre | — | gerada via `/kai-newsletter` |
...
| Atividade | Champion | Comitê | maintainers | Tech Lead |
|---|---|---|---|---|
...
Rastreadas via `/kai-leaderboard` apenas por squad:
