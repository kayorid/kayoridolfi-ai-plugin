...
printf "${BOLD}Kayoridolfi AI Plugin · Pilot Check${RESET} ${DIM}— $(date -u +%FT%TZ)${RESET}\n"
...
check "version sync (9 plugins)"  "bash plugins/kai-ai-core/scripts/version.sh 2>&1 | grep -q 'sincronizado'"
...
Próximos passos (em ${BOLD}PILOT-SETUP.md${RESET}):
  ...
  ${ORANGE}▸${RESET} Fase 5 — Criar projeto piloto e rodar /kai-init
