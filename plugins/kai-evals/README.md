...
| Comando | Propósito |
|---------|-----------|
| `/kai-evals-init <feature>` | Scaffolding de eval (dataset + rubric + runner) |
| `/kai-evals-run <feature>` | Executa eval, gera relatório |
| `/kai-evals-compare <feature> <ver-a> <ver-b>` | A/B test de prompts/modelos |
...
- `kai-ai-core` ativo.
- `kai-sdd` recomendado: ciclo SDD ganha fase EVAL extra entre VERIFY e REVIEW para features AI.
- `kai-cost` recomendado: relaciona qualidade vs custo.
