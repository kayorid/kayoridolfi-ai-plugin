...
`/kai-evals-init <feature>` cria scaffolding em `evals/<feature>/`.
...
- `/kai-evals-run` — eval simples, gera relatório.
- `/kai-evals-compare prompt-v1 prompt-v2` — A/B side-by-side.
- `/kai-evals-ci` — em PR, falha se abaixo do threshold.
