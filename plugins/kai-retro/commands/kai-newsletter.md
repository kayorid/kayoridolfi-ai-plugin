...
Diferente de `/kai-retro-quarterly` (que invoca a skill `kai-learning-extractor` para gerar análise narrativa), este comando produz **artefato distribuível** pronto para email/intranet — HTML inline-styled compatível com Gmail/Outlook.

## Como rodar

```bash
bash plugins/kai-retro/scripts/newsletter.sh           # trimestre atual
bash plugins/kai-retro/scripts/newsletter.sh 2026-Q2   # trimestre específico
```
