---
name: kai-learning-extractor
description: Use para agregar retros de múltiplas features (do squad ou do projeto inteiro) e identificar padrões promovíveis a skills, hooks ou regras de constitution. Acione via /kai-retro-quarterly ou quando o maintainers pedir "ver tendências de aprendizado", "consolidar retros", "identificar padrões". Produz relatório executivo e propostas concretas.
---
...
- comunidade-wide: solicitar export consolidado (futuro: dashboard).
...
### Para constitution
- [ ] <proposta> — abrir PR ao kayoridolfi-ai-plugin
...
- Compartilhar com maintainers e AI Champions.
...
- Distinguir "problema do squad X" de "problema do KAI" — promover só o segundo.
