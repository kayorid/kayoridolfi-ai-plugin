...
# Mostra versões de todos os plugins Kayoridolfi AI instalados e versão do marketplace.
...
if [[ $ANY_MISMATCH -eq 1 ]]; then
  printf "\n${W}⚠${R} Há plugins dessincronizados. Rode ${B}/kai-update${R} ou abra issue.\n\n"
  exit 1
fi
