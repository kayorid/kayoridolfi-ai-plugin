# Tutorial guiado Kayoridolfi AI · Roteiro

Tempo: 45-60 min. Pré-requisito: sandbox criado via `/kai-tutorial init`.

## Cenário

Você é dev no squad **listings** da app DemoTrading. Sua próxima tarefa: **adicionar o par BTC/USDC** à listagem.
...
1. Domínio: "Gerenciar pares de trading da app DemoTrading."
...
Verifique que `.kai/CLAUDE.md` foi gerado.

## Passo 2 (15 min) — Spec da feature

```
/kai-spec adicionar-par-btc-usdc
```

Conduza pelo ciclo. Em cada fase, **aprove** com `/kai-approve <FASE>`.
...
```bash
echo "# Kayoridolfi AI Tutorial concluído" > tutorial-completed.md
