...
# Fonte de verdade: time financeiro
PRICE_IN_PER_MTOK="${KAI_PRICE_IN:-3.00}"   # USD por 1M input tokens (Opus padrão)
PRICE_OUT_PER_MTOK="${KAI_PRICE_OUT:-15.00}" # USD por 1M output tokens
USD_BRL="${KAI_USD_BRL:-5.30}"               # cotação aproximada
...
echo ""
echo -e "${P}${B}Kayoridolfi AI · Custo de IA · ${LABEL}${R}"
echo -e "${D}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${R}"
...
echo -e "${D}Ajuste via env: KAI_PRICE_IN, KAI_PRICE_OUT, KAI_USD_BRL${R}"
echo ""
