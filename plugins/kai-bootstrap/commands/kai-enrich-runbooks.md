...
1. Identifique o fluxo (passe como argumento ou pergunte ao usuário, sugerindo da lista de "fluxos críticos" em `.kai/CLAUDE.md`).
...
3. Gere `.kai/runbooks/<slug-do-fluxo>.md` estruturado.
4. Atualize `.kai/runbooks/README.md` com link.
5. Crie commit:
   ```
   git commit -m "[kai-enrich-runbooks] runbook para <fluxo>"
   ```
