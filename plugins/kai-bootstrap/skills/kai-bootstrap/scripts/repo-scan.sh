#!/usr/bin/env bash
# kai-bootstrap / repo-scan
# Análise automática do repositório — gera .kai/bootstrap/analysis.md
set -euo pipefail

OUT_DIR=".kai/bootstrap"
mkdir -p "$OUT_DIR"
...
Após a entrevista, gere \`.kai/CLAUDE.md\` combinando esta análise com as respostas humanas.
EOF
