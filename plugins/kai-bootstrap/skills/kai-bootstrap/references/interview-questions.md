...
*Define como `kai-review` deve se integrar ao fluxo do squad.*
...
*Vai virar `.kai/glossary.md` — o agente usa para entender o contexto certo.*
...
- **Registro:** anote literalmente, sem reformular. Reformulação para `.kai/CLAUDE.md` é depois.
