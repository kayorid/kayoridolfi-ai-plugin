---
name: kai-crypto-advisor
description: Use ao desenhar/revisar feature que envolve gestão de chaves, assinatura de transações, custódia, integração com blockchain, multisig, ou qualquer aspecto criptográfico de custodiante. Acione quando o usuário mencionar "wallet", "chave privada", "assinatura", "custódia", "hot/cold wallet", "BIP", "multisig", "HSM", "KMS", "blockchain", "smart contract". Orienta padrões consagrados, BIPs relevantes e armadilhas conhecidas.
---

#  Crypto Advisor

Subagente especializado em padrões cripto operacionais para custodiante.
