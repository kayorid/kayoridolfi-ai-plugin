---
name: kai-threat-modeler
description: Use ao desenhar feature que toca ativos críticos (autenticação, autorização, dados regulados, fundos, chaves, transações, integração com blockchains). Acione na fase PLAN do ciclo SDD para features sensíveis, ou via /kai-threat-model. Conduz STRIDE estruturado e produz THREAT-MODEL.md com ameaças, impacto, mitigações e validação.
---

#  Threat Modeler

Conduz threat modeling estruturado usando STRIDE com foco em fintech ou cripto.
...
- Feature integra com sistemas externos externos (especialmente blockchains).
...
- Insider threat é real (especialmente em produtos com custódia).
