...
# /kai-compliance-check

Invoque a skill `kai-compliance-advisor` e conduza check para a regulação especificada:
...
Para dúvidas de interpretação ou impacto regulatório real, sempre envolva equipe de Compliance/Jurídico.
