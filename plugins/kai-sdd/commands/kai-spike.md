...
1. **Validação:**
   ...
   - Se for "construir feature", redirecione para `/kai-spec`.
2. **Setup:**
...
3. **Estrutura do `spike.md`:**
   ...
   - **Decisão:** o que fazer com o aprendizado (parar, virar feature `/kai-spec`, mudar abordagem).
4. **Execução:**
...
5. **Conclusão:**
   ...
   - Se a decisão for "virar feature", abra `/kai-spec` referenciando o spike.
